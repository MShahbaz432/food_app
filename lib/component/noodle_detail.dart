...
class NoodleDetail extends StatefulWidget {
  const NoodleDetail({super.key});

  @override
  State<NoodleDetail> createState() => _NoodleDetailState();
}

class _NoodleDetailState extends State<NoodleDetail> {
  bool favourite = true;
  @override
