...
class ItalianPizzaDetail extends StatefulWidget {
  const ItalianPizzaDetail({super.key});

  @override
  State<ItalianPizzaDetail> createState() => _ItalianPizzaDetailState();
}

class _ItalianPizzaDetailState extends State<ItalianPizzaDetail> {
  bool favourite = true;
  @override
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                  image: AssetImage('assets/images/italian_pizza.png'),
                  fit: BoxFit.cover),
            ),
          ),
          Container(
