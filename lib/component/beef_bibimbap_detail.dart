...
class BeefBibimbapDetail extends StatefulWidget {
  const BeefBibimbapDetail({super.key});

  @override
  State<BeefBibimbapDetail> createState() => _BeefBibimbapDetailState();
}

class _BeefBibimbapDetailState extends State<BeefBibimbapDetail> {
  bool favourite = true;
  @override
